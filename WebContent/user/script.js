...
var success = "회원가입에 성공하였습니다.^^";
var addinputsuccess = "추가정보 입력에 성공하였습니다.^^";
...
var emailerror2 = "@는 1개만 입력 가능합니다.";
...
function confirmcheck() {
	if( ! confirmform.id.value ) {
		...
		confirmform.id.focus();
		return false;
	} else if( confirmform.id.value.substring(confirmform.id.value.indexOf("@")+1).indexOf("@") != -1 ) {
		alert( emailerror2 );
		confirmform.id.focus();
		return false;
	}
...
function confirmid() {
	if( ! inputform.id.value ) {
		...
		inputform.id.focus();
		return false;
	} else if( inputform.id.value.substring(inputform.id.value.indexOf("@")+1).indexOf("@") != -1 ) {
		alert( emailerror2 );
		inputform.id.focus();
		return false;
	} else {
