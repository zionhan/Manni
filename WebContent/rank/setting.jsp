...
<c:set var="project" value="/Manni/user/"/>

<c:set var="page_main" value="유저 페이지"/>
...
<c:set var="page_info" value="내 정보"/>
...
<c:set var="msg_login" value="회원가입에 성공하였습니다<br> 지금 당장 Manni를 즐기세요!"/>
...
<c:set var="str_vote" value="좋아요 수"/>
...
<c:set var="str_ablepjt" value="프로젝트 가능 여부"/>
