...
<body id="fadein">
		<div> 
			<form method="post" name="modifyForm" action="discModifyPro.do" onsubmit="return modifycheck()">
				...
				<table border="1" class="centerTable">
					<tr>
						...
						<th>${discDto.nickName}${discDto.dNum}</th>
						<th>${discDto.dWriteDate}</th>
						<th>댓글수</th>
					</tr>
					<tr>
						<th colspan="3">
							<input type="text" name="dTitle" value="${discDto.dTitle}">
						</th>
					</tr>
					<tr>
						<th colspan="3">
							<input type="text" name="dContent" value="${discDto.dContent}">
						</th>
					</tr>
					<tr>
						<th colspan="4">
